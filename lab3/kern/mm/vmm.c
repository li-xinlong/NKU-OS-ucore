...
// find_vma 函数用于查找当前进程中给定地址 addr 所在的虚拟内存区域（VMA）。如果找到了，则返回该 VMA 结构体的指针；否则返回 NULL。
struct vma_struct *
...
int do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr)
{
    ...
    {
        /*LAB3 EXERCISE 3: 2212599 2212294 2212045
         * 请你根据以下信息提示，补充函数
