...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	3ee040ef          	jal	ra,ffffffffc0204438 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	41a58593          	addi	a1,a1,1050 # ffffffffc0204468 <etext+0x6>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	43250513          	addi	a0,a0,1074 # ffffffffc0204488 <etext+0x26>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	6d9030ef          	jal	ra,ffffffffc0203f86 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	6a3030ef          	jal	ra,ffffffffc0203f86 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	38c50513          	addi	a0,a0,908 # ffffffffc0204490 <etext+0x2e>
void print_kerninfo(void) {
...
ffffffffc020011e:	39650513          	addi	a0,a0,918 # ffffffffc02044b0 <etext+0x4e>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	33c58593          	addi	a1,a1,828 # ffffffffc0204462 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	3a250513          	addi	a0,a0,930 # ffffffffc02044d0 <etext+0x6e>
...
ffffffffc0200146:	3ae50513          	addi	a0,a0,942 # ffffffffc02044f0 <etext+0x8e>
...
ffffffffc020015a:	3ba50513          	addi	a0,a0,954 # ffffffffc0204510 <etext+0xae>
...
ffffffffc0200188:	3ac50513          	addi	a0,a0,940 # ffffffffc0204530 <etext+0xce>
}
...
ffffffffc0200196:	3ce60613          	addi	a2,a2,974 # ffffffffc0204560 <etext+0xfe>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	3da50513          	addi	a0,a0,986 # ffffffffc0204578 <etext+0x116>
void print_stackframe(void) {
...
ffffffffc02001b2:	3e260613          	addi	a2,a2,994 # ffffffffc0204590 <etext+0x12e>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	3fa58593          	addi	a1,a1,1018 # ffffffffc02045b0 <etext+0x14e>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	3fa50513          	addi	a0,a0,1018 # ffffffffc02045b8 <etext+0x156>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	3fc60613          	addi	a2,a2,1020 # ffffffffc02045c8 <etext+0x166>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	41c58593          	addi	a1,a1,1052 # ffffffffc02045f0 <etext+0x18e>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	3dc50513          	addi	a0,a0,988 # ffffffffc02045b8 <etext+0x156>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	41860613          	addi	a2,a2,1048 # ffffffffc0204600 <etext+0x19e>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	43058593          	addi	a1,a1,1072 # ffffffffc0204620 <etext+0x1be>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	3c050513          	addi	a0,a0,960 # ffffffffc02045b8 <etext+0x156>
...
ffffffffc0200236:	3fe50513          	addi	a0,a0,1022 # ffffffffc0204630 <etext+0x1ce>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	40450513          	addi	a0,a0,1028 # ffffffffc0204658 <etext+0x1f6>
...
ffffffffc020027e:	40648493          	addi	s1,s1,1030 # ffffffffc0204680 <etext+0x21e>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	404b0b13          	addi	s6,s6,1028 # ffffffffc0204688 <etext+0x226>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	324a0a13          	addi	s4,s4,804 # ffffffffc02045b0 <etext+0x14e>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	070040ef          	jal	ra,ffffffffc0204308 <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	148040ef          	jal	ra,ffffffffc0204404 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	134040ef          	jal	ra,ffffffffc0204404 <strcmp>
...
ffffffffc020030e:	114040ef          	jal	ra,ffffffffc0204422 <strchr>
...
ffffffffc020034c:	0d6040ef          	jal	ra,ffffffffc0204422 <strchr>
...
ffffffffc020036a:	34250513          	addi	a0,a0,834 # ffffffffc02046a8 <etext+0x246>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	793030ef          	jal	ra,ffffffffc020444a <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	76f030ef          	jal	ra,ffffffffc020444a <memcpy>
    return 0;
}
...
ffffffffc0201760:	4d9020ef          	jal	ra,ffffffffc0204438 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201802:	437020ef          	jal	ra,ffffffffc0204438 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201f60:	492020ef          	jal	ra,ffffffffc02043f2 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	498020ef          	jal	ra,ffffffffc0204404 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb9c>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	416020ef          	jal	ra,ffffffffc02043bc <strlen>
...
ffffffffc0203040:	641000ef          	jal	ra,ffffffffc0203e80 <swapfs_write>
...
ffffffffc0203dd8:	45b5                	li	a1,13
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e34:	02e7f963          	bgeu	a5,a4,ffffffffc0203e66 <swapfs_read+0x80>
}
...
ffffffffc0203e58:	45d1                	li	a1,20
ffffffffc0203e5a:	00002517          	auipc	a0,0x2
ffffffffc0203e5e:	2d650513          	addi	a0,a0,726 # ffffffffc0206130 <default_pmm_manager+0xf88>
...
ffffffffc0203e70:	3cc60613          	addi	a2,a2,972 # ffffffffc0205238 <default_pmm_manager+0x90>
ffffffffc0203e74:	00001517          	auipc	a0,0x1
ffffffffc0203e78:	38c50513          	addi	a0,a0,908 # ffffffffc0205200 <default_pmm_manager+0x58>
ffffffffc0203e7c:	cf8fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e80 <swapfs_write>:
...
ffffffffc0203e84:	00855793          	srli	a5,a0,0x8
ffffffffc0203e88:	c3a5                	beqz	a5,ffffffffc0203ee8 <swapfs_write+0x68>
ffffffffc0203e8a:	0000d717          	auipc	a4,0xd
ffffffffc0203e8e:	6b673703          	ld	a4,1718(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e92:	04e7fb63          	bgeu	a5,a4,ffffffffc0203ee8 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e96:	0000d617          	auipc	a2,0xd
ffffffffc0203e9a:	69263603          	ld	a2,1682(a2) # ffffffffc0211528 <pages>
ffffffffc0203e9e:	8d91                	sub	a1,a1,a2
ffffffffc0203ea0:	4035d613          	srai	a2,a1,0x3
ffffffffc0203ea4:	00002597          	auipc	a1,0x2
ffffffffc0203ea8:	50c5b583          	ld	a1,1292(a1) # ffffffffc02063b0 <error_string+0x38>
ffffffffc0203eac:	02b60633          	mul	a2,a2,a1
ffffffffc0203eb0:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203eb4:	00002797          	auipc	a5,0x2
ffffffffc0203eb8:	5047b783          	ld	a5,1284(a5) # ffffffffc02063b8 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ebc:	0000d717          	auipc	a4,0xd
ffffffffc0203ec0:	66473703          	ld	a4,1636(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ece:	02e7f963          	bgeu	a5,a4,ffffffffc0203f00 <swapfs_write+0x80>
}
ffffffffc0203ed2:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203ed4:	0000d797          	auipc	a5,0xd
ffffffffc0203ed8:	6647b783          	ld	a5,1636(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203edc:	46a1                	li	a3,8
ffffffffc0203ede:	963e                	add	a2,a2,a5
ffffffffc0203ee0:	4505                	li	a0,1
}
ffffffffc0203ee2:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203ee4:	de0fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203ee8:	86aa                	mv	a3,a0
ffffffffc0203eea:	00002617          	auipc	a2,0x2
ffffffffc0203eee:	25e60613          	addi	a2,a2,606 # ffffffffc0206148 <default_pmm_manager+0xfa0>
ffffffffc0203ef2:	45e5                	li	a1,25
ffffffffc0203ef4:	00002517          	auipc	a0,0x2
ffffffffc0203ef8:	23c50513          	addi	a0,a0,572 # ffffffffc0206130 <default_pmm_manager+0xf88>
ffffffffc0203efc:	c78fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203f00:	86b2                	mv	a3,a2
ffffffffc0203f02:	06a00593          	li	a1,106
ffffffffc0203f06:	00001617          	auipc	a2,0x1
ffffffffc0203f0a:	33260613          	addi	a2,a2,818 # ffffffffc0205238 <default_pmm_manager+0x90>
ffffffffc0203f0e:	00001517          	auipc	a0,0x1
ffffffffc0203f12:	2f250513          	addi	a0,a0,754 # ffffffffc0205200 <default_pmm_manager+0x58>
ffffffffc0203f16:	c5efc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203f1a <printnum>:
 * */
static void
...
ffffffffc0203f1a:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f1e:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203f20:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f24:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203f26:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f2a:	f022                	sd	s0,32(sp)
ffffffffc0203f2c:	ec26                	sd	s1,24(sp)
ffffffffc0203f2e:	e84a                	sd	s2,16(sp)
ffffffffc0203f30:	f406                	sd	ra,40(sp)
ffffffffc0203f32:	e44e                	sd	s3,8(sp)
ffffffffc0203f34:	84aa                	mv	s1,a0
ffffffffc0203f36:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203f38:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203f3c:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203f3e:	03067e63          	bgeu	a2,a6,ffffffffc0203f7a <printnum+0x60>
ffffffffc0203f42:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203f44:	00805763          	blez	s0,ffffffffc0203f52 <printnum+0x38>
ffffffffc0203f48:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203f4a:	85ca                	mv	a1,s2
ffffffffc0203f4c:	854e                	mv	a0,s3
ffffffffc0203f4e:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203f50:	fc65                	bnez	s0,ffffffffc0203f48 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f52:	1a02                	slli	s4,s4,0x20
ffffffffc0203f54:	00002797          	auipc	a5,0x2
ffffffffc0203f58:	21478793          	addi	a5,a5,532 # ffffffffc0206168 <default_pmm_manager+0xfc0>
ffffffffc0203f5c:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203f60:	9a3e                	add	s4,s4,a5
}
ffffffffc0203f62:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f64:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203f68:	70a2                	ld	ra,40(sp)
ffffffffc0203f6a:	69a2                	ld	s3,8(sp)
ffffffffc0203f6c:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f6e:	85ca                	mv	a1,s2
ffffffffc0203f70:	87a6                	mv	a5,s1
}
ffffffffc0203f72:	6942                	ld	s2,16(sp)
ffffffffc0203f74:	64e2                	ld	s1,24(sp)
ffffffffc0203f76:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f78:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203f7a:	03065633          	divu	a2,a2,a6
ffffffffc0203f7e:	8722                	mv	a4,s0
ffffffffc0203f80:	f9bff0ef          	jal	ra,ffffffffc0203f1a <printnum>
ffffffffc0203f84:	b7f9                	j	ffffffffc0203f52 <printnum+0x38>

ffffffffc0203f86 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f86:	7119                	addi	sp,sp,-128
ffffffffc0203f88:	f4a6                	sd	s1,104(sp)
ffffffffc0203f8a:	f0ca                	sd	s2,96(sp)
ffffffffc0203f8c:	ecce                	sd	s3,88(sp)
ffffffffc0203f8e:	e8d2                	sd	s4,80(sp)
ffffffffc0203f90:	e4d6                	sd	s5,72(sp)
ffffffffc0203f92:	e0da                	sd	s6,64(sp)
ffffffffc0203f94:	fc5e                	sd	s7,56(sp)
ffffffffc0203f96:	f06a                	sd	s10,32(sp)
ffffffffc0203f98:	fc86                	sd	ra,120(sp)
ffffffffc0203f9a:	f8a2                	sd	s0,112(sp)
ffffffffc0203f9c:	f862                	sd	s8,48(sp)
ffffffffc0203f9e:	f466                	sd	s9,40(sp)
ffffffffc0203fa0:	ec6e                	sd	s11,24(sp)
ffffffffc0203fa2:	892a                	mv	s2,a0
ffffffffc0203fa4:	84ae                	mv	s1,a1
ffffffffc0203fa6:	8d32                	mv	s10,a2
ffffffffc0203fa8:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203faa:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203fae:	5b7d                	li	s6,-1
ffffffffc0203fb0:	00002a97          	auipc	s5,0x2
ffffffffc0203fb4:	1eca8a93          	addi	s5,s5,492 # ffffffffc020619c <default_pmm_manager+0xff4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203fb8:	00002b97          	auipc	s7,0x2
ffffffffc0203fbc:	3c0b8b93          	addi	s7,s7,960 # ffffffffc0206378 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fc0:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203fc4:	001d0413          	addi	s0,s10,1
ffffffffc0203fc8:	01350a63          	beq	a0,s3,ffffffffc0203fdc <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203fcc:	c121                	beqz	a0,ffffffffc020400c <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203fce:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fd0:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203fd2:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fd4:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203fd8:	ff351ae3          	bne	a0,s3,ffffffffc0203fcc <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fdc:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203fe0:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203fe4:	4c81                	li	s9,0
ffffffffc0203fe6:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203fe8:	5c7d                	li	s8,-1
ffffffffc0203fea:	5dfd                	li	s11,-1
ffffffffc0203fec:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203ff0:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ff2:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203ff6:	0ff5f593          	zext.b	a1,a1
ffffffffc0203ffa:	00140d13          	addi	s10,s0,1
ffffffffc0203ffe:	04b56263          	bltu	a0,a1,ffffffffc0204042 <vprintfmt+0xbc>
ffffffffc0204002:	058a                	slli	a1,a1,0x2
ffffffffc0204004:	95d6                	add	a1,a1,s5
ffffffffc0204006:	4194                	lw	a3,0(a1)
ffffffffc0204008:	96d6                	add	a3,a3,s5
ffffffffc020400a:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc020400c:	70e6                	ld	ra,120(sp)
ffffffffc020400e:	7446                	ld	s0,112(sp)
ffffffffc0204010:	74a6                	ld	s1,104(sp)
ffffffffc0204012:	7906                	ld	s2,96(sp)
ffffffffc0204014:	69e6                	ld	s3,88(sp)
ffffffffc0204016:	6a46                	ld	s4,80(sp)
ffffffffc0204018:	6aa6                	ld	s5,72(sp)
ffffffffc020401a:	6b06                	ld	s6,64(sp)
ffffffffc020401c:	7be2                	ld	s7,56(sp)
ffffffffc020401e:	7c42                	ld	s8,48(sp)
ffffffffc0204020:	7ca2                	ld	s9,40(sp)
ffffffffc0204022:	7d02                	ld	s10,32(sp)
ffffffffc0204024:	6de2                	ld	s11,24(sp)
ffffffffc0204026:	6109                	addi	sp,sp,128
ffffffffc0204028:	8082                	ret
            padc = '0';
ffffffffc020402a:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc020402c:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204030:	846a                	mv	s0,s10
ffffffffc0204032:	00140d13          	addi	s10,s0,1
ffffffffc0204036:	fdd6059b          	addiw	a1,a2,-35
ffffffffc020403a:	0ff5f593          	zext.b	a1,a1
ffffffffc020403e:	fcb572e3          	bgeu	a0,a1,ffffffffc0204002 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204042:	85a6                	mv	a1,s1
ffffffffc0204044:	02500513          	li	a0,37
ffffffffc0204048:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020404a:	fff44783          	lbu	a5,-1(s0)
ffffffffc020404e:	8d22                	mv	s10,s0
ffffffffc0204050:	f73788e3          	beq	a5,s3,ffffffffc0203fc0 <vprintfmt+0x3a>
ffffffffc0204054:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204058:	1d7d                	addi	s10,s10,-1
ffffffffc020405a:	ff379de3          	bne	a5,s3,ffffffffc0204054 <vprintfmt+0xce>
ffffffffc020405e:	b78d                	j	ffffffffc0203fc0 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204060:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc020406a:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020406e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204072:	02d86463          	bltu	a6,a3,ffffffffc020409a <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204076:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc020407a:	002c169b          	slliw	a3,s8,0x2
ffffffffc020407e:	0186873b          	addw	a4,a3,s8
ffffffffc0204082:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204086:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204088:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc020408c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020408e:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204092:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204096:	fed870e3          	bgeu	a6,a3,ffffffffc0204076 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc020409a:	f40ddce3          	bgez	s11,ffffffffc0203ff2 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020409e:	8de2                	mv	s11,s8
ffffffffc02040a0:	5c7d                	li	s8,-1
ffffffffc02040a2:	bf81                	j	ffffffffc0203ff2 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02040a4:	fffdc693          	not	a3,s11
ffffffffc02040a8:	96fd                	srai	a3,a3,0x3f
ffffffffc02040aa:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040ae:	00144603          	lbu	a2,1(s0)
ffffffffc02040b2:	2d81                	sext.w	s11,s11
ffffffffc02040b4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040b6:	bf35                	j	ffffffffc0203ff2 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02040b8:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040bc:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02040c0:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040c2:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02040c4:	bfd9                	j	ffffffffc020409a <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02040c6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040c8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040cc:	01174463          	blt	a4,a7,ffffffffc02040d4 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02040d0:	1a088e63          	beqz	a7,ffffffffc020428c <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02040d4:	000a3603          	ld	a2,0(s4)
ffffffffc02040d8:	46c1                	li	a3,16
ffffffffc02040da:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02040dc:	2781                	sext.w	a5,a5
ffffffffc02040de:	876e                	mv	a4,s11
ffffffffc02040e0:	85a6                	mv	a1,s1
ffffffffc02040e2:	854a                	mv	a0,s2
ffffffffc02040e4:	e37ff0ef          	jal	ra,ffffffffc0203f1a <printnum>
            break;
ffffffffc02040e8:	bde1                	j	ffffffffc0203fc0 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02040ea:	000a2503          	lw	a0,0(s4)
ffffffffc02040ee:	85a6                	mv	a1,s1
ffffffffc02040f0:	0a21                	addi	s4,s4,8
ffffffffc02040f2:	9902                	jalr	s2
            break;
ffffffffc02040f4:	b5f1                	j	ffffffffc0203fc0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02040f6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040f8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040fc:	01174463          	blt	a4,a7,ffffffffc0204104 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204100:	18088163          	beqz	a7,ffffffffc0204282 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204104:	000a3603          	ld	a2,0(s4)
ffffffffc0204108:	46a9                	li	a3,10
ffffffffc020410a:	8a2e                	mv	s4,a1
ffffffffc020410c:	bfc1                	j	ffffffffc02040dc <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020410e:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204112:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204114:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204116:	bdf1                	j	ffffffffc0203ff2 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204118:	85a6                	mv	a1,s1
ffffffffc020411a:	02500513          	li	a0,37
ffffffffc020411e:	9902                	jalr	s2
            break;
ffffffffc0204120:	b545                	j	ffffffffc0203fc0 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204122:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204126:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204128:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020412a:	b5e1                	j	ffffffffc0203ff2 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc020412c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020412e:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204132:	01174463          	blt	a4,a7,ffffffffc020413a <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204136:	14088163          	beqz	a7,ffffffffc0204278 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc020413a:	000a3603          	ld	a2,0(s4)
ffffffffc020413e:	46a1                	li	a3,8
ffffffffc0204140:	8a2e                	mv	s4,a1
ffffffffc0204142:	bf69                	j	ffffffffc02040dc <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204144:	03000513          	li	a0,48
...
ffffffffc0204150:	07800513          	li	a0,120
ffffffffc0204154:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204156:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204158:	6782                	ld	a5,0(sp)
ffffffffc020415a:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020415c:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204160:	bfb5                	j	ffffffffc02040dc <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204162:	000a3403          	ld	s0,0(s4)
ffffffffc0204166:	008a0713          	addi	a4,s4,8
ffffffffc020416a:	e03a                	sd	a4,0(sp)
ffffffffc020416c:	14040263          	beqz	s0,ffffffffc02042b0 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204170:	0fb05763          	blez	s11,ffffffffc020425e <vprintfmt+0x2d8>
ffffffffc0204174:	02d00693          	li	a3,45
ffffffffc0204178:	0cd79163          	bne	a5,a3,ffffffffc020423a <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020417c:	00044783          	lbu	a5,0(s0)
ffffffffc0204180:	0007851b          	sext.w	a0,a5
ffffffffc0204184:	cf85                	beqz	a5,ffffffffc02041bc <vprintfmt+0x236>
ffffffffc0204186:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020418a:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020418e:	000c4563          	bltz	s8,ffffffffc0204198 <vprintfmt+0x212>
ffffffffc0204192:	3c7d                	addiw	s8,s8,-1
ffffffffc0204194:	036c0263          	beq	s8,s6,ffffffffc02041b8 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204198:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020419a:	0e0c8e63          	beqz	s9,ffffffffc0204296 <vprintfmt+0x310>
ffffffffc020419e:	3781                	addiw	a5,a5,-32
ffffffffc02041a0:	0ef47b63          	bgeu	s0,a5,ffffffffc0204296 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02041a4:	03f00513          	li	a0,63
ffffffffc02041a8:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041aa:	000a4783          	lbu	a5,0(s4)
ffffffffc02041ae:	3dfd                	addiw	s11,s11,-1
ffffffffc02041b0:	0a05                	addi	s4,s4,1
ffffffffc02041b2:	0007851b          	sext.w	a0,a5
ffffffffc02041b6:	ffe1                	bnez	a5,ffffffffc020418e <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02041b8:	01b05963          	blez	s11,ffffffffc02041ca <vprintfmt+0x244>
ffffffffc02041bc:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02041be:	85a6                	mv	a1,s1
ffffffffc02041c0:	02000513          	li	a0,32
ffffffffc02041c4:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02041c6:	fe0d9be3          	bnez	s11,ffffffffc02041bc <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02041ca:	6a02                	ld	s4,0(sp)
ffffffffc02041cc:	bbd5                	j	ffffffffc0203fc0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02041ce:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02041d0:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02041d4:	01174463          	blt	a4,a7,ffffffffc02041dc <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02041d8:	08088d63          	beqz	a7,ffffffffc0204272 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02041dc:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02041e0:	0a044d63          	bltz	s0,ffffffffc020429a <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02041e4:	8622                	mv	a2,s0
ffffffffc02041e6:	8a66                	mv	s4,s9
ffffffffc02041e8:	46a9                	li	a3,10
ffffffffc02041ea:	bdcd                	j	ffffffffc02040dc <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02041ec:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02041f0:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc02041f2:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02041f4:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02041f8:	8fb5                	xor	a5,a5,a3
ffffffffc02041fa:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02041fe:	02d74163          	blt	a4,a3,ffffffffc0204220 <vprintfmt+0x29a>
ffffffffc0204202:	00369793          	slli	a5,a3,0x3
ffffffffc0204206:	97de                	add	a5,a5,s7
ffffffffc0204208:	639c                	ld	a5,0(a5)
ffffffffc020420a:	cb99                	beqz	a5,ffffffffc0204220 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020420c:	86be                	mv	a3,a5
ffffffffc020420e:	00002617          	auipc	a2,0x2
ffffffffc0204212:	f8a60613          	addi	a2,a2,-118 # ffffffffc0206198 <default_pmm_manager+0xff0>
ffffffffc0204216:	85a6                	mv	a1,s1
ffffffffc0204218:	854a                	mv	a0,s2
ffffffffc020421a:	0ce000ef          	jal	ra,ffffffffc02042e8 <printfmt>
ffffffffc020421e:	b34d                	j	ffffffffc0203fc0 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204220:	00002617          	auipc	a2,0x2
ffffffffc0204224:	f6860613          	addi	a2,a2,-152 # ffffffffc0206188 <default_pmm_manager+0xfe0>
ffffffffc0204228:	85a6                	mv	a1,s1
ffffffffc020422a:	854a                	mv	a0,s2
ffffffffc020422c:	0bc000ef          	jal	ra,ffffffffc02042e8 <printfmt>
ffffffffc0204230:	bb41                	j	ffffffffc0203fc0 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204232:	00002417          	auipc	s0,0x2
ffffffffc0204236:	f4e40413          	addi	s0,s0,-178 # ffffffffc0206180 <default_pmm_manager+0xfd8>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020423a:	85e2                	mv	a1,s8
ffffffffc020423c:	8522                	mv	a0,s0
ffffffffc020423e:	e43e                	sd	a5,8(sp)
ffffffffc0204240:	196000ef          	jal	ra,ffffffffc02043d6 <strnlen>
ffffffffc0204244:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204248:	01b05b63          	blez	s11,ffffffffc020425e <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc020424c:	67a2                	ld	a5,8(sp)
ffffffffc020424e:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204252:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204254:	85a6                	mv	a1,s1
ffffffffc0204256:	8552                	mv	a0,s4
ffffffffc0204258:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020425a:	fe0d9ce3          	bnez	s11,ffffffffc0204252 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020425e:	00044783          	lbu	a5,0(s0)
ffffffffc0204262:	00140a13          	addi	s4,s0,1
ffffffffc0204266:	0007851b          	sext.w	a0,a5
ffffffffc020426a:	d3a5                	beqz	a5,ffffffffc02041ca <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020426c:	05e00413          	li	s0,94
ffffffffc0204270:	bf39                	j	ffffffffc020418e <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204272:	000a2403          	lw	s0,0(s4)
ffffffffc0204276:	b7ad                	j	ffffffffc02041e0 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204278:	000a6603          	lwu	a2,0(s4)
ffffffffc020427c:	46a1                	li	a3,8
ffffffffc020427e:	8a2e                	mv	s4,a1
ffffffffc0204280:	bdb1                	j	ffffffffc02040dc <vprintfmt+0x156>
ffffffffc0204282:	000a6603          	lwu	a2,0(s4)
ffffffffc0204286:	46a9                	li	a3,10
ffffffffc0204288:	8a2e                	mv	s4,a1
ffffffffc020428a:	bd89                	j	ffffffffc02040dc <vprintfmt+0x156>
ffffffffc020428c:	000a6603          	lwu	a2,0(s4)
ffffffffc0204290:	46c1                	li	a3,16
ffffffffc0204292:	8a2e                	mv	s4,a1
ffffffffc0204294:	b5a1                	j	ffffffffc02040dc <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204296:	9902                	jalr	s2
ffffffffc0204298:	bf09                	j	ffffffffc02041aa <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc020429a:	85a6                	mv	a1,s1
ffffffffc020429c:	02d00513          	li	a0,45
ffffffffc02042a0:	e03e                	sd	a5,0(sp)
ffffffffc02042a2:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02042a4:	6782                	ld	a5,0(sp)
ffffffffc02042a6:	8a66                	mv	s4,s9
ffffffffc02042a8:	40800633          	neg	a2,s0
ffffffffc02042ac:	46a9                	li	a3,10
ffffffffc02042ae:	b53d                	j	ffffffffc02040dc <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02042b0:	03b05163          	blez	s11,ffffffffc02042d2 <vprintfmt+0x34c>
ffffffffc02042b4:	02d00693          	li	a3,45
ffffffffc02042b8:	f6d79de3          	bne	a5,a3,ffffffffc0204232 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02042bc:	00002417          	auipc	s0,0x2
ffffffffc02042c0:	ec440413          	addi	s0,s0,-316 # ffffffffc0206180 <default_pmm_manager+0xfd8>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02042c4:	02800793          	li	a5,40
ffffffffc02042c8:	02800513          	li	a0,40
ffffffffc02042cc:	00140a13          	addi	s4,s0,1
ffffffffc02042d0:	bd6d                	j	ffffffffc020418a <vprintfmt+0x204>
ffffffffc02042d2:	00002a17          	auipc	s4,0x2
ffffffffc02042d6:	eafa0a13          	addi	s4,s4,-337 # ffffffffc0206181 <default_pmm_manager+0xfd9>
ffffffffc02042da:	02800513          	li	a0,40
ffffffffc02042de:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02042e2:	05e00413          	li	s0,94
ffffffffc02042e6:	b565                	j	ffffffffc020418e <vprintfmt+0x208>

ffffffffc02042e8 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02042e8:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02042ea:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02042ee:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02042f0:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02042f2:	ec06                	sd	ra,24(sp)
ffffffffc02042f4:	f83a                	sd	a4,48(sp)
ffffffffc02042f6:	fc3e                	sd	a5,56(sp)
ffffffffc02042f8:	e0c2                	sd	a6,64(sp)
ffffffffc02042fa:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc02042fc:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02042fe:	c89ff0ef          	jal	ra,ffffffffc0203f86 <vprintfmt>
}
ffffffffc0204302:	60e2                	ld	ra,24(sp)
ffffffffc0204304:	6161                	addi	sp,sp,80
ffffffffc0204306:	8082                	ret

ffffffffc0204308 <readline>:
...
ffffffffc0204308:	715d                	addi	sp,sp,-80
ffffffffc020430a:	e486                	sd	ra,72(sp)
ffffffffc020430c:	e0a6                	sd	s1,64(sp)
ffffffffc020430e:	fc4a                	sd	s2,56(sp)
ffffffffc0204310:	f84e                	sd	s3,48(sp)
ffffffffc0204312:	f452                	sd	s4,40(sp)
ffffffffc0204314:	f056                	sd	s5,32(sp)
ffffffffc0204316:	ec5a                	sd	s6,24(sp)
ffffffffc0204318:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc020431a:	c901                	beqz	a0,ffffffffc020432a <readline+0x22>
ffffffffc020431c:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc020431e:	00002517          	auipc	a0,0x2
ffffffffc0204322:	e7a50513          	addi	a0,a0,-390 # ffffffffc0206198 <default_pmm_manager+0xff0>
ffffffffc0204326:	d95fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc020432a:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc020432c:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc020432e:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc0204330:	4aa9                	li	s5,10
ffffffffc0204332:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc0204334:	0000db97          	auipc	s7,0xd
ffffffffc0204338:	dc4b8b93          	addi	s7,s7,-572 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020433c:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc0204340:	db3fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204344:	00054a63          	bltz	a0,ffffffffc0204358 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204348:	00a95a63          	bge	s2,a0,ffffffffc020435c <readline+0x54>
ffffffffc020434c:	029a5263          	bge	s4,s1,ffffffffc0204370 <readline+0x68>
        c = getchar();
ffffffffc0204350:	da3fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204354:	fe055ae3          	bgez	a0,ffffffffc0204348 <readline+0x40>
            return NULL;
ffffffffc0204358:	4501                	li	a0,0
ffffffffc020435a:	a091                	j	ffffffffc020439e <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc020435c:	03351463          	bne	a0,s3,ffffffffc0204384 <readline+0x7c>
ffffffffc0204360:	e8a9                	bnez	s1,ffffffffc02043b2 <readline+0xaa>
        c = getchar();
ffffffffc0204362:	d91fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204366:	fe0549e3          	bltz	a0,ffffffffc0204358 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020436a:	fea959e3          	bge	s2,a0,ffffffffc020435c <readline+0x54>
...
ffffffffc0204378:	009b87b3          	add	a5,s7,s1
ffffffffc020437c:	2485                	addiw	s1,s1,1
ffffffffc020437e:	00a78023          	sb	a0,0(a5)
ffffffffc0204382:	bf7d                	j	ffffffffc0204340 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc0204384:	01550463          	beq	a0,s5,ffffffffc020438c <readline+0x84>
ffffffffc0204388:	fb651ce3          	bne	a0,s6,ffffffffc0204340 <readline+0x38>
            cputchar(c);
ffffffffc020438c:	d65fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc0204390:	0000d517          	auipc	a0,0xd
ffffffffc0204394:	d6850513          	addi	a0,a0,-664 # ffffffffc02110f8 <buf>
ffffffffc0204398:	94aa                	add	s1,s1,a0
ffffffffc020439a:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc020439e:	60a6                	ld	ra,72(sp)
ffffffffc02043a0:	6486                	ld	s1,64(sp)
ffffffffc02043a2:	7962                	ld	s2,56(sp)
ffffffffc02043a4:	79c2                	ld	s3,48(sp)
ffffffffc02043a6:	7a22                	ld	s4,40(sp)
ffffffffc02043a8:	7a82                	ld	s5,32(sp)
ffffffffc02043aa:	6b62                	ld	s6,24(sp)
ffffffffc02043ac:	6bc2                	ld	s7,16(sp)
ffffffffc02043ae:	6161                	addi	sp,sp,80
ffffffffc02043b0:	8082                	ret
            cputchar(c);
ffffffffc02043b2:	4521                	li	a0,8
ffffffffc02043b4:	d3dfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc02043b8:	34fd                	addiw	s1,s1,-1
ffffffffc02043ba:	b759                	j	ffffffffc0204340 <readline+0x38>

ffffffffc02043bc <strlen>:
...
strlen(const char *s) {
ffffffffc02043c0:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02043c2:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02043c4:	cb81                	beqz	a5,ffffffffc02043d4 <strlen+0x18>
        cnt ++;
ffffffffc02043c6:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02043c8:	00a707b3          	add	a5,a4,a0
ffffffffc02043cc:	0007c783          	lbu	a5,0(a5)
ffffffffc02043d0:	fbfd                	bnez	a5,ffffffffc02043c6 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc02043d6:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc02043d8:	e589                	bnez	a1,ffffffffc02043e2 <strnlen+0xc>
ffffffffc02043da:	a811                	j	ffffffffc02043ee <strnlen+0x18>
        cnt ++;
ffffffffc02043dc:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc02043de:	00f58863          	beq	a1,a5,ffffffffc02043ee <strnlen+0x18>
ffffffffc02043e2:	00f50733          	add	a4,a0,a5
ffffffffc02043e6:	00074703          	lbu	a4,0(a4)
ffffffffc02043ea:	fb6d                	bnez	a4,ffffffffc02043dc <strnlen+0x6>
ffffffffc02043ec:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc02043ee:	852e                	mv	a0,a1
ffffffffc02043f0:	8082                	ret

ffffffffc02043f2 <strcpy>:
char *
...
ffffffffc02043fa:	0585                	addi	a1,a1,1
ffffffffc02043fc:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204400:	fb75                	bnez	a4,ffffffffc02043f4 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204408:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020440c:	cb89                	beqz	a5,ffffffffc020441e <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020440e:	0505                	addi	a0,a0,1
ffffffffc0204410:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204412:	fee789e3          	beq	a5,a4,ffffffffc0204404 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
...
ffffffffc0204420:	bfed                	j	ffffffffc020441a <strcmp+0x16>

ffffffffc0204422 <strchr>:
...
ffffffffc0204426:	c799                	beqz	a5,ffffffffc0204434 <strchr+0x12>
        if (*s == c) {
ffffffffc0204428:	00f58763          	beq	a1,a5,ffffffffc0204436 <strchr+0x14>
    while (*s != '\0') {
ffffffffc020442c:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204430:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204432:	fbfd                	bnez	a5,ffffffffc0204428 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204438:	ca01                	beqz	a2,ffffffffc0204448 <memset+0x10>
ffffffffc020443a:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc020443c:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc020443e:	0785                	addi	a5,a5,1
ffffffffc0204440:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204444:	fec79de3          	bne	a5,a2,ffffffffc020443e <memset+0x6>
    }
    return s;
...
ffffffffc020444a <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc020444a:	ca19                	beqz	a2,ffffffffc0204460 <memcpy+0x16>
ffffffffc020444c:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc020444e:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204450:	0005c703          	lbu	a4,0(a1)
ffffffffc0204454:	0585                	addi	a1,a1,1
ffffffffc0204456:	0785                	addi	a5,a5,1
ffffffffc0204458:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc020445c:	fec59ae3          	bne	a1,a2,ffffffffc0204450 <memcpy+0x6>
    }
    return dst;
